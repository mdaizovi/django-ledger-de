...
DJANGO_LEDGER_DB_ROUTER_HINT_KEY = getattr(settings, 'DJANGO_LEDGER_DB_ROUTER_HINT_KEY', 'djl_action')
DJANGO_LEDGER_DB_ATOMIC_ALIAS = getattr(settings, 'DJANGO_LEDGER_DB_ATOMIC_ALIAS', None)