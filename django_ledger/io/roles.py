...
# --> EBITDA <----
GROUP_PNL_EBITDA = [
    *GROUP_PNL_OPERATING_REVENUES,
    *GROUP_PNL_COGS,
    *GROUP_PNL_OPERATING_EXPENSES,
    *GROUP_EXPENSE_OTHER
]

GROUP_PNL_NET_PROFIT = GROUP_INCOME + GROUP_COGS + GROUP_EXPENSES
...
GROUP_VERBOSE_NAME = {
    ...
    'GROUP_PNL_OPERATING_REVENUES': _('Operating Revenues'),
    'GROUP_PNL_OTHER_EXPENSES': _('Other Expenses'),
    'GROUP_PNL_OTHER_REVENUES': _('Other Revenues'),
